...
export const DIPENDENTI_CONFIG = {
  MESSAGES: {
    ...
    NO_RESULTS: 'Nessun dipendente trovato.',
    NO_DATA: 'Nessun dipendente presente.',
    ACCESS_DENIED: 'Accesso negato. Solo gli amministratori possono accedere a questa sezione.'
  }
};
